module gamebuyu.page {
	...
	*/
    export class BuyuGunItem extends Laya.Box {
        ...
        //炮台视图对象
        private _viewUI: ui.game_ui.buyu.component.BuYu_GunItemUI;
        //炮台逻辑位置
        ...
        constructor(showPos: number, game: Game) {
            ...
            this._game = game;
            //视图对象
            this._viewUI = new ui.game_ui.buyu.component.BuYu_GunItemUI();
            ...
            if (!this._goldClip) {
                this._goldClip = new BuyuClip(BuyuClip.MONEY_FONT2);
